...
public class LoginVO {
	...
	private String c_email; // 회원이메일
	private String c_phone; // 회원연락처
	private String c_birth; // 회원생일
	private String c_gender; // 성별
	private String c_state; // 회원상태
	private String c_level; // 회원등급
	private String c_position; // 회원진영
	private String c_memo; // 회원메모
	private String c_regdate; // 회원등록일
